...
const displayCart = () => {
    ...
    checkoutButton.addEventListener("click", function(){
        ...
        const ordeData = {
            quantity: 1,
            description: "compra de ecoamerce"
            price:total ,
        };
    ...
    // Initialize the checkout
        ...
        const rendercomponent = async (bricksBuiIder) {
        //if (window.checkout8utton) checkoutButton. unmount();
    ...
    window.checkoutButton = renderComponent(bricksBuiIder);
}
